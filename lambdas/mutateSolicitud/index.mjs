...
export const handler = async (event) => {
  try {
    ...
    await logActivity({
      type: "solicitud",
      icon: accion === "aprobar" ? "solar:user-check-rounded-bold-duotone" : "solar:user-cross-rounded-bold-duotone",
      color: accion === "aprobar" ? "#22c55e" : "#ef4444",
      text: `Solicitud de ${existing.Item.nombre} ${accion === "aprobar" ? "aprobada" : "rechazada"}`,
