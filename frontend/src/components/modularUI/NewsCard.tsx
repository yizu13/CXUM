    ...
    >
      ...
      <div className="relative overflow-hidden" style={{ height: 210 }}>
        ...
        <span
          ...
          style={{ background: news.categoryColor, color: "#fff", letterSpacing: "0.03em" }}
        >
          {news.category}
        </span>
      </div>
      ...
      <div className="flex flex-col gap-3 p-5 flex-1">
        <div className="flex items-center gap-3" style={{ color: isDark ? "rgba(255,255,255,0.35)" : "#94a3b8" }}>
        ...
        <div className="flex items-center justify-between pt-2 mt-auto border-t"
          ...
          <span className="text-xs font-semibold" style={{ color: isDark ? "rgba(255,255,255,0.4)" : "#94a3b8" }}>
            {news.author}
          </span>
          <motion.span
