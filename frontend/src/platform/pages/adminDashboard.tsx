  ...
  return (
    <div className="p-3 sm:p-6 max-w-7xl mx-auto">
      ...
      >
        ...
        <h1 className="font-black text-xl sm:text-2xl tracking-tight mt-4" style={{ color: textPrimary }}>
        ...
        {[
          ...
          >
            <div className="flex items-center justify-between mb-2 sm:mb-3">
              ...
              >
                <Iconify Size={16} IconString={kpi.icon} Style={{ color: kpi.color }} />
              </div>
              <span className="text-[10px] sm:text-xs font-medium hidden sm:block" style={{ color: textSecondary }}>{kpi.sub}</span>
            </div>
            <p className="font-black text-2xl sm:text-3xl" style={{ color: textPrimary }}>{kpi.value}</p>
            <p className="text-[11px] sm:text-xs font-medium mt-1 leading-tight" style={{ color: textSecondary }}>{kpi.label}</p>
          </motion.div>
        ))}
      </div>
